...
var joao = new Person('Joao', 'Juventus', 28);
var maria = new Person('Maria', 'Martine', 20);
var carlos = new Person('Carlos', 'Cardoso', 34);
/*
...
//addAge retorna o próprio objeto portanto pode encadear com o outro método que foi necessário em seguida
